                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    ...
                                    <p style="font-size: 14px; color: #16a1fd; padding-top: 12px;">The Best Selling Premium HTML Template</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;border:1px solid #e3edf8;border-bottom:4px solid #00d285;">
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 15px 30px;">
                                    <h2 style="font-size: 18px; color: #00d285; font-weight: 600; margin: 0;">Password Reseted</h2>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © 2018 TokenWiz. <br> Template Made By <a style="color: #16a1fd; text-decoration:none;" href="https://themeforest.net/user/softnio/portfolio">Softnio</a> &amp; Handcrafted by iO.</p>
