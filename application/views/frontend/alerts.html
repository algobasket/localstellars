        ...
        <div class="container">
            <div class="content-area card">
                <div class="card-innr card-innr-fix">
                    ...
                    <p>For proper styling, use one of the required contextual classes <code>(e.g., .alert-success)</code></p>
                    ...
                    <p>For inline dismissal, use the alerts jQuery plugin.<code></code></p>
                    ...
                    <div class="hr"></div>
                    <div class="card-head">
                        <h5 class="card-title">Alerts Alternet</h5>
                    </div>
                    <div class="gaps-1x"></div>
                    <p>For an alternet or filled styling use this contextual class <code>(e.g., .alert-success-alt)</code></p>
                    <div class="alert alert-primary-alt">
                        A simple primary alternet alert—check it out!
                    </div>
                    <div class="alert alert-secondary-alt">
                        A simple secondary alternet alert—check it out!
                    </div>
                    <div class="alert alert-success-alt">
                        A simple success alternet alert—check it out!
                    </div>
                    <div class="alert alert-danger-alt">
                        A simple danger alternet alert—check it out!
                    </div>
                    <div class="alert alert-warning-alt">
                        A simple warning alternet alert—check it out!
                    </div>
                    <div class="alert alert-info-alt">
                        A simple info alternet alert—check it out!
                    </div>
                    <div class="alert alert-light-alt">
                        A simple light alternet alert—check it out!
                    </div>
                    <div class="alert alert-dark-alt">
                        A simple dark alternet alert—check it out!
                    </div>
                    <p>With link <code></code></p>
                    <div class="alert alert-info-alt">
                        A simple primary alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                    </div>
                    <p>For inline dismissal, use the alerts jQuery plugin.<code></code></p>
                    ...
                    <div class="hr"></div>
                    <div class="card-head">
                        <h5 class="card-title">Alerts Centered</h5>
                    </div>
                    <div class="gaps-1x"></div>
                    <p>For centered styling use this contextual class <code>(e.g., .alert-center)</code></p>
                    <div class="alert alert-primary alert-center">
                        A simple primary alternet alert—check it out!
                    </div>
                    <div class="alert alert-secondary alert-center">
                        A simple secondary alternet alert—check it out!
                    </div>
                    ...
                    <div class="alert alert-dark alert-center">
                        A simple dark alternet alert—check it out!
                    </div>
                    <p class="text-center">With link <code></code></p>
                    <div class="alert alert-info alert-center">
                        A simple primary alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                    </div>
                    <p class="text-center">For inline dismissal, use the alerts jQuery plugin.<code></code></p>
