            ...
            <div class="row">
                <div class="main-content col-lg-8">
                    <div class="content-area card"> 
                        <div class="card-innr">
                            <div class="card-head">
                                <h4 class="card-title">Wallet Transactions <?php echo currentBaseCurrency();?></h4>
                            </div>
                            <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?php echo base_url();?>account/wallet_transactions">Transactions</a>
                                </li>
                            </ul><!-- .nav-tabs-line -->
