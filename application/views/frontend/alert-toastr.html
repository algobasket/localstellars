        ...
        <div class="container">
            <div class="content-area card">
                <div class="card-innr card-innr-fix">
                    <div class="card-head">
                        <h6 class="card-title">Toastr Position</h6>
                    </div>
                    <div class="gaps-1x"></div>
                    <div class="row guttar-vr-20px">
                        <div class="col-lg-3"><code>.toastr-top-center</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-top-center">Top Center</a></div>
                        <div class="col-lg-3"><code>.toastr-top-right</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-top-right">Top Right</a></div>
                        <div class="col-lg-3"><code>.toastr-top-left</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-top-left">Top Left</a></div>
                        <div class="col-lg-3"><code>.toastr-top-full</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-top-full">Top Full</a></div>
                        <div class="col-lg-3"><code>.toastr-bottom-center</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-bottom-center">Bottom Center</a></div>
                        <div class="col-lg-3"><code>.toastr-bottom-right</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-bottom-right">Bottom Right</a></div>
                        <div class="col-lg-3"><code>.toastr-bottom-left</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-bottom-left">Bottom Left</a></div>
                        <div class="col-lg-3"><code>.toastr-bottom-full</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-primary toastr-bottom-full">Bottom Full</a></div>
                    </div>
                    <div class="hr"></div>
                    <div class="card-head">
                        <h6 class="card-title">Toastr Type</h6>
                    </div>
                    <div class="gaps-1x"></div>
                    <div class="row guttar-vr-20px">
                        <div class="col-lg-3"><code>.toastr-info</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-info toastr-info">Toastr Info</a></div>
                        <div class="col-lg-3"><code>.toastr-success</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-success toastr-success">Toastr Success</a></div>
                        <div class="col-lg-3"><code>.toastr-warning</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-warning toastr-warning">Toastr Warning</a></div>
                        <div class="col-lg-3"><code>.toastr-error</code></div>
                        <div class="col-lg-3"><a href="#" class="btn btn-danger toastr-error">Toastr Error</a></div>
                    </div>
                </div>
            </div><!-- .card -->
        </div><!-- .container -->
