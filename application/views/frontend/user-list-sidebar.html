                    ...
                    <div class="card card-navs">
                        <div class="card-innr">
                            ...
                            <ul class="sidebar-nav">
                                <li><a href="#"><em class="ikon ikon-user"></em> Users</a></li>
                                <li><a href="#"><em class="ikon ikon-exchange"></em> Groups</a></li>
                                ...
                                <tbody>
                                    <tr class="data-item">
                                        ...
                                        <td class="data-col dt-email">
                                            <span class="sub sub-s2 sub-email">info(at)softnio.com</span>
                                        </td>
                                    ...
                                    <tr class="data-item">
                                        <td class="data-col dt-user">
                                            <div class="user-block">
                                                ...
                                                <div class="user-info">
                                                    <span class="lead user-name">Helena Walz</span>
                                                    <span class="sub user-id">UD102005</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="data-col dt-email">
                                    ...
                                    <tr class="data-item">
                                        <td class="data-col dt-user">
                                            <div class="user-block">
                                                ...
                                                <div class="user-info">
                                                    <span class="lead user-name">Sherice Digangi</span>
                                                    <span class="sub user-id">UD102023</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="data-col dt-email">
                                            <span class="sub sub-s2 sub-email">info@shericedigangi.com</span>
                                        </td>
                                        <td class="data-col dt-status">
                                    ...
                                    <tr class="data-item">
                                        <td class="data-col dt-user">
                                           <div class="user-block">
                                                ...
                                                <div class="user-info">
                                                    <span class="lead user-name">Darren Square</span>
                                                    <span class="sub user-id">UD102028</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="data-col dt-email">
                                            <span class="sub sub-s2 sub-email">info@darrensq.com</span>
                                        </td>
                                        <td class="data-col dt-status">
                                            <span class="dt-status-md badge badge-outline badge-success badge-md">Active</span>
                                            <span class="dt-status-sm badge badge-sq badge-outline badge-success badge-md">A</span>
                                    ...
                                    <tr class="data-item">
                                        <td class="data-col dt-user">
                                           <div class="user-block">
                                                ...
                                                <div class="user-info">
                                                    <span class="lead user-name">Patrick Reader</span>
                                                    <span class="sub user-id">UD102037</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="data-col dt-email">
                                            <span class="sub sub-s2 sub-email">patrick-94@example.com</span>
                                        </td>
                                        <td class="data-col dt-status">
                                            <span class="dt-status-md badge badge-outline badge-success badge-md">Active</span>
                                            <span class="dt-status-sm badge badge-sq badge-outline badge-success badge-md">A</span>
                                    ...
                                    <tr class="data-item">
                                        <td class="data-col dt-user">
                                            <div class="user-block">
                                                <div class="user-photo bg-light">AB</div>
                                                <div class="user-info">
                                                    <span class="lead user-name">Abu Bin Ishtiyak</span>
                                                    <span class="sub user-id">UD102001</span>
                                                </div>
                                    ...
                                    <tr class="data-item">
                                        <td class="data-col dt-user">
                                            <div class="user-block">
                                                <div class="user-photo bg-info">AB</div>
                                                <div class="user-info">
                                                    <span class="lead user-name">Abu Bin Ishtiyak</span>
                                                    <span class="sub user-id">UD102001</span>
                                                </div>
