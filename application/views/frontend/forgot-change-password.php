    ...
    <div class="page-ath-wrap">
        <div class="page-ath-content" style="background-color: goldenrod">
            ...
            <div class="page-ath-form">
                <h2 class="page-ath-heading">Change password <span>Put your new password to reset your old password.</span></h2>
                <?php echo form_open('auth/resetpassword/'.$exId.'/'.$resetCode);?>
                    <div class="input-item">
                        <input type="text" placeholder="New Password" class="input-bordered" name="newPassword" required />
                    </div>
                    <div class="input-item">
                        <input type="text" placeholder="Confirm Password" class="input-bordered" name="confirmPassword" required />
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <input type="submit" name="changePassword" class="btn btn-primary btn-block" value="Send Reset Link"/>
                        </div>
                        <div>
