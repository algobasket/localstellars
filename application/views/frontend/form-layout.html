        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7 text-center">
                    <h2 class="page-title">Form Layouts</h2>
                </div>
            </div>
        </div><!-- .container -->
    </div>
            ...
            <div class="row">
                        ...
                        <div class="card-innr card-innr-fix">
                            ...
                            <form action="#">
                                <div class="input-item input-with-label">
                                    ...
                                    <span class="input-note">Please enter Your Full Name</span>
                                </div>
                                <div class="input-item input-with-label">
                                ...
                                <label class="input-item-label ucap text-exlight">Communication</label>
                                <ul class="d-flex flex-wrap checkbox-list">
                                    <li>
                                        <div class="input-item text-left">
                                            <input class="input-checkbox input-checkbox-sm" id="cm-email" type="checkbox">
                                            <label for="cm-email">Email</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-item text-left">
                                            <input class="input-checkbox input-checkbox-sm" id="cm-sms" type="checkbox">
                                            <label for="cm-sms">SMS</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-item text-left">
                                            <input class="input-checkbox input-checkbox-sm" id="cm-phone" type="checkbox">
                                ...
                                <label class="input-item-label ucap text-exlight">Payment options</label>
                                <ul class="d-flex flex-wrap checkbox-list">
                                    <li>
                                        <div class="input-item text-left">
                                            <input class="input-checkbox input-checkbox-sm" id="pm-card" type="checkbox">
                                            <label for="pm-card">Card</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-item text-left">
                                            <input class="input-checkbox input-checkbox-sm" id="pm-bitcoin" type="checkbox">
                                            <label for="pm-bitcoin">Bitcoin</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="input-item text-left">
                                            <input class="input-checkbox input-checkbox-sm" id="pm-cash" type="checkbox">
                ...
                <div class="col-lg-6">
                    <div class="content-area card">
                        <div class="card-innr card-innr-fix">
                            <div class="card-head">
                                <h6 class="card-title">Contact Form</h6>
                            </div>
                            <div class="gaps-1x"></div><!-- .gaps -->
                            <form action="#">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label text-exlight">First Name</label>
                                    <input class="input-bordered" type="text">
                                </div>
                                <div class="input-item input-with-label">
                                    <label class="input-item-label text-exlight">Last Name</label>
                                    <input class="input-bordered" type="text">
                                </div>
                                <div class="input-item input-with-label">
                                ...
                                <div class="input-item input-with-label">
                                    ...
                                    <textarea class="input-bordered input-textarea"></textarea>
                                </div>
                                <div class="gaps-1x"></div>
                ...
                <div class="col-lg-12">
                    <div class="content-area card">
                        <div class="card-innr card-innr-fix">
                            <div class="card-head">
                                <h6 class="card-title">Customer Info s2</h6>
                            </div>
                            <div class="gaps-1x"></div><!-- .gaps -->
                            <form action="#">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <ul class="d-flex flex-wrap checkbox-list">
                                            <li>
                                                <div class="input-item text-left">
                                                    <input class="input-checkbox input-checkbox-sm" id="cma-email" type="checkbox">
                                                    <label for="cma-email">Email</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="input-item text-left">
                                                    <input class="input-checkbox input-checkbox-sm" id="cma-sms" type="checkbox">
                                                    <label for="cma-sms">SMS</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="input-item text-left">
                                                    <input class="input-checkbox input-checkbox-sm" id="cma-phone" type="checkbox">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="d-flex flex-wrap checkbox-list">
                                            <li>
                                                <div class="input-item text-left">
                                                    <input class="input-checkbox input-checkbox-sm" id="pma-card" type="checkbox">
                                                    <label for="pma-card">Card</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="input-item text-left">
                                                    <input class="input-checkbox input-checkbox-sm" id="pma-bitcoin" type="checkbox">
                                                    <label for="pma-bitcoin">Bitcoin</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="input-item text-left">
                                                    <input class="input-checkbox input-checkbox-sm" id="pma-cash" type="checkbox">
                                                    <label for="pma-cash">Cash</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="content-area card">
                        <div class="card-innr card-innr-fix">
                            <div class="card-head">
                                <h6 class="card-title">Contact Form s2</h6>
                            </div>
                            <div class="gaps-1x"></div><!-- .gaps -->
                            <form action="#">
                               <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="content-area card">
                        <div class="card-innr card-innr-fix2">
                            <div class="card-head">
                                <h6 class="card-title">Form with Grid layout</h6>
                            </div>
                            <div class="gaps-1x"></div><!-- .gaps -->
                            <div class="row">
                                <div class="col-xl-3 col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label ucap text-exlight">Input Label</label>
                                        <input class="input-bordered" type="text">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="content-area card">
                        <div class="card-innr">
                            <div class="card-head">
                                <h6 class="card-title">Form with Note</h6>
                            </div>
                            <div class="gaps-1x"></div><!-- .gaps -->
                            <div class="row">
                                <div class="col-xl-3 col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label ucap text-exlight">Input Label</label>
                                        <input class="input-bordered" type="text">
                                        <span class="input-note">Its a simple note for input element.</span>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-sm-6">
                                    <div class="input-item input-with-label">
                ...
                <div class="col-lg-12">
                    <div class="content-area card">
                        <div class="card-innr">
                            <div class="card-head">
                                <h6 class="card-title">Form with Icon</h6>
                            </div>
                            <div class="gaps-1x"></div><!-- .gaps -->
                            <div class="row">
                                <div class="col-xl-3 col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label ucap text-exlight">Input Label</label>
                                        <div class="relative">
                                            <span class="input-icon input-icon-right"><em class="ti ti-user"></em></span>
                                            <input class="input-bordered" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label ucap text-exlight">Input Label</label>
                                        <div class="relative">
                                            <span class="input-icon input-icon-right"><em class="ti ti-world"></em></span>
                                            <input class="input-bordered" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label ucap text-exlight">Input Label</label>
                                        <div class="relative">
                                            <span class="input-icon input-icon-right"><em class="ti ti-star"></em></span>
                                            <input class="input-bordered" type="text">
                                        </div>
                                    </div>
                                </div>
