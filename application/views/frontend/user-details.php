                ...
                <div class="card-innr card-innr-fix">
                    ...
                    <div class="data-details d-md-flex">
                        <div class="fake-class">
                            ...
                            <span class="data-details-info large">10,000</span>
                        </div>
                        <div class="fake-class">
                    ...
                    <ul class="data-details-list">
                        <li>
                            ...
                            <div class="data-details-des">Abu Bin Ishtiyak</div>
                        </li><!-- li -->
                        <li>
                        ...
                        <li>
                            ...
                            <div class="data-details-des">info@softnio.com</div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">Mobile Number</div>
                            <div class="data-details-des">01713040400</div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">Date of Birth</div>
                            <div class="data-details-des">10 Aug, 1980</div>
                        </li><!-- li -->
                    </ul>
                    <div class="gaps-3x"></div>
                    ...
                    <ul class="data-details-list">
                        <li>
                            ...
                            <div class="data-details-des">08-16-2018  09:04PM</div>
                        </li><!-- li -->
                        <li>
