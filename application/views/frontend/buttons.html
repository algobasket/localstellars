    ...
    <div class="page-content">
        <div class="container">
            <div class="content-area card">
                <div class="card-innr">
                    <div class="card-head">
                        <h6 class="card-title">Buttons Style</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="row align-items-center guttar-vr-20px">
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-light">Light</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-lighter">Lighter</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-dark">Dark</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-primary">Primary</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-secondary">Secondary</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-success">Success</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-warning">Warning</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-danger">Danger</a></div>
                    </div>
                    <div class="hr"></div>
                    <div class="card-head">
                        <h6 class="card-title">Buttons Alternet Style</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="row align-items-center guttar-vr-20px">
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-light-alt">Light</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-lighter-alt">Lighter</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-dark-alt">Dark</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-primary-alt">Primary</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-secondary-alt">Secondary</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-success-alt">Success</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-warning-alt">Warning</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-danger-alt">Danger</a></div>
                    </div>
                    <div class="hr"></div>
                    <div class="card-head">
                        <h6 class="card-title">Buttons Outline</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="row align-items-center guttar-vr-20px">
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-light">Light</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-lighter">Lighter</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-dark">Dark</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-primary">Primary</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-secondary">Secondary</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-success">Success</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-warning">Warning</a></div>
                        <div class="col-6 col-lg-3"><a href="#" class="btn btn-outline btn-danger">Danger</a></div>
                    </div>
                    <div class="hr"></div>
                    <div class="card-head">
                    ...
                    <div class="d-flex flex-wrap align-items-end guttar-20px guttar-vr-20px">
                        <div class="flex-col"><span class="btn btn-xl btn-primary btn-auto">Extra Large</span></div>
                        <div class="flex-col"><span class="btn btn-lg btn-primary btn-auto">Large</span></div>
                        <div class="flex-col"><span class="btn btn-primary btn-auto">Regular</span></div>
                        <div class="flex-col"><span class="btn btn-sm btn-primary btn-auto">Small</span></div>
                        <div class="flex-col"><span class="btn btn-xs btn-primary btn-auto">Extra Small</span></div>
                    </div>
                </div>
            </div><!-- .card -->
