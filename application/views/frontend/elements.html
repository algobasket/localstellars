    ...
    <div class="page-content">
        <div class="container">
            <div class="content-area card">
                <div class="card-innr">
                    <div class="card-head">
                        <h6 class="card-title">Elements</h6>
                    </div>
                    <div class="card-text">
                        <p>In our TokenWiz template available lots of elements which is helps you finish your project. <br> You can see all the element example by clicking bellow link.</p>
					...
					<div class="card-head">
                        <h6 class="card-title">Looking for more elements?</h6>
                    </div>
					<div class="card-text">
						<p>Need in more elements to complete your project? Our expert team of designers and developers are ready to transform those. <br> <strong>Feel free to contact us and team will discuss with you further steps.</strong></p>
					</div>
                </div>
            </div><!-- .card -->
