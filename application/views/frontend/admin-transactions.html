                        ...
                        <tbody>
                            <tr class="data-item">
                                ...
                                <td class="data-col dt-amount">
                                    ...
                                    <span class="sub sub-symbol">ETH <em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="1 ETH = 100 TWZ"></em></span>
                                </td>
                                <td class="data-col dt-usd-amount">
                                    <span class="lead amount-pay">245.52</span>
                                    <span class="sub sub-symbol">USD <em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="1 ETH = 100 TWZ"></em></span>
                                </td>
