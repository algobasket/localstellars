        ...
        <div class="container">
            <div class="content-area card">
                <div class="card-innr card-innr-fix">
                    <div class="card-head">
                        <h6 class="card-title">Badge Styles</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="row align-items-center guttar-vr-20px">
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-light">Light</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-lighter">Lighter</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-dark">Dark</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-primary">Primary</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-secondary">Secondary</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-success">Success</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-warning">Warning</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-md badge-danger">Danger</span></div>
                    </div>
                    <div class="hr"></div>
                    <div class="card-head">
                        <h6 class="card-title">Badge Dim Style</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="row align-items-center guttar-vr-20px">
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-light">Light</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-lighter">Lighter</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-dark">Dark</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-primary">Primary</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-secondary">Secondary</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-success">Success</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-warning">Warning</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-dim badge-md badge-danger">Danger</span></div>
                    </div>
                    <div class="hr"></div>
                    <div class="card-head">
                        <h6 class="card-title">Badge Outnine Style</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="row align-items-center guttar-vr-20px">
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-light">Light</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-lighter">Lighter</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-dark">Dark</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-primary">Primary</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-secondary">Secondary</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-success">Success</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-warning">Warning</span></div>
                        <div class="col-6 col-lg-3"><span class="badge badge-outline badge-md badge-danger">Danger</span></div>
                    </div>
                    <div class="hr"></div>
                    <div class="card-head">
                        <h6 class="card-title">Badge Size</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="d-flex flex-wrap align-items-end guttar-20px guttar-vr-20px">
                        <div class="flex-col"><span class="badge badge-xl badge-primary">Ex Large</span></div>
                        <div class="flex-col"><span class="badge badge-lg badge-primary">Large</span></div>
                        <div class="flex-col"><span class="badge badge-md badge-primary">Regular</span></div>
                        <div class="flex-col"><span class="badge badge-sm badge-primary">Small</span></div>
                        <div class="flex-col"><span class="badge badge-primary">Ex Small</span></div>
                    </div>
                </div>
            </div><!-- .card -->
