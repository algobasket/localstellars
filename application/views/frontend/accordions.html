    ...
    <div class="page-content">
        <div class="container">
            <div class="content-area card">
                <div class="card-innr">
                    <div class="card-head">
                        <h5 class="card-title">Accordion Style</h5>
                    </div>
                    <div class="gaps-1x"></div>
                    <div class="accordion" id="accordion-1">
                        <div class="accordion-item">
                            <h6 class="accordion-heading" data-toggle="collapse" data-target="#collapse-1-1"> What is Tokenwiz?  </h6>
                    ...
                    <div class="hr"></div>
                    <div class="card-head">
                        <h6 class="card-title">Accordion Style Alternet</h6>
                    </div>
                    <div class="gaps-1x"></div><!-- .gaps -->
                    <div class="accordion accordion-s2" id="accordion-2">
                        <div class="accordion-item">
                            <h6 class="accordion-heading" data-toggle="collapse" data-target="#collapse-2-1"> What is Tokenwiz?  </h6>
                        ...
                        <div class="accordion-item">
                            <h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-2-2">What cryptocurrencies can I use to purchase?</h6>
                        ...
                        <div class="accordion-item">
                            <h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-2-3">How can I participate in the ICO Token sale?</h6>
                        ...
                        <div class="accordion-item">
                            <h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-2-4">How do I benefit from the ICO Token?</h6>
