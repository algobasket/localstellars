            ...
            <div class="row">
                <div class="main-content col-lg-8">
                    <div class="content-area card">
                        <div class="card-innr">
                           <div class="card-head">
                                <h4 class="card-title">Receive <?php echo currentBaseCurrency();?></h4>
                            </div>
                            <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo base_url();?>account/wallet">Send <?php echo currentBaseCurrency();?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?php echo base_url();?>account/wallet_receive">Receive <?php echo currentBaseCurrency();?></a>
                                </li>
                                <li class="nav-item">
